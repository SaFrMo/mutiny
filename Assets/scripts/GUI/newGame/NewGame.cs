...
public class NewGame : MonoBehaviour {
	...
	private List<string> subtitleList = new List<string>() {
		"Tom Walker was, to be honest, boring. He reported for duty every morning and ate and drank with his friends every night.",
		...
		"The way it rolls and bucks is an echo of the way this cannon, weighing as much as every crewmember aboard put together, pitched and yawed aboard the ship, causing havoc wherever it lumbered.",
		"Tom Walker's cannon had become a danger to us all. He and everyone else knew it was his fault, and so he jumped in himself to snare the beast.",
